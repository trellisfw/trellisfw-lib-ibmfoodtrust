...
module.exports = {
  ...
  organization: {
    ...
    phone: "0000000000",
    gln: "urn:ibm:ift:location:loc:7457934435.gln0071430000106" //"0728612177446"
  },

  // Scope: what sorts of things does this audit cover (operation, products, etc.)
  scope: {
    description:
      "Harvest crew audit of GFS activities, personnel, sanitation, crop area, " +
    ...
    products_observed: [{ name: "Tomatoes" }],
    similar_products_not_observed: [{ name: "Tomatoes Organic" }],
